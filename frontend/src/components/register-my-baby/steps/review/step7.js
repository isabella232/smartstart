...
import schema from '../schemas/step7'
import getFieldReviewProps from './get-field-review-props'

const renderStep7Review = ({formState, onEdit, countries}) => {
  ...
  const birthCertificateDeliveryAddresses = getBirthCertificateDeliveryAddresses(isOtherParent, preferedTitle)
...
renderStep7Review.propTypes = {
  formState: PropTypes.object,
  onEdit: PropTypes.func,
  countries: PropTypes.array
}

export default renderStep7Review
