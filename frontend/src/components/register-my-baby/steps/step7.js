...
class OrderCertificatesForm extends Component {
  ...
  render() {
    ...
    const birthCertificateDeliveryAddresses = getBirthCertificateDeliveryAddresses(isOtherParent, secondParentPreferedTitle)
    ...
    return (
      <div id="step-7">
        <h2 className="step-heading">
          ...
          <span className="step-number">{ MYIR_ENABLED ? 7 : 6 }</span>
