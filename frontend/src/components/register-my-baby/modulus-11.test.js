...
describe('Bank account modulus-11 digit check', () => {
  test('valid 0009020068389001: 16 digits', () => {
    expect(validateBankAccountNumber('0009020068389001')).toBeTruthy()
  })

  test('valid 000902006838901: 15 digits', () => {
    expect(validateBankAccountNumber('000902006838901')).toBeTruthy()
  })

  test('invalid 0009020068389: 13 digits', () => {
    expect(validateBankAccountNumber('0009020068389')).toBeFalsy()
  })

  test('invalid 55AS17121: 9 digits, invalid characters', () => {
    expect(validateBankAccountNumber('55AS17121')).toBeFalsy()
  })
})
