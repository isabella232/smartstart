...
export function checkOutages(page) {
  return OUTAGES
    .filter(outage => {
      const nowTime = new Date().getTime()
      const startTime = new Date(outage.startDate).getTime()
      const endTime = new Date(outage.expiryDate).getTime()

      return (
        outage.pages.includes(page) &&
...
export const capitalizeWordsAll = str => str.split(' ')
